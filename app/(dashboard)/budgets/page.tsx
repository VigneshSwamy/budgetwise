    ...
    return (
      <main className="space-y-6">
        <div>
          ...
          <p className="text-stone-500">Manage your monthly spending limits.</p>
        </div>
        <div className="rounded-xl border border-stone-200 bg-white p-8 text-center shadow-soft-md">
          <p className="mb-4 text-stone-600">Create a group to start budgeting.</p>
          <Link
            href="/groups/create"
      ...
      {categories.length > 0 ? (
        <div className="grid gap-6 md:grid-cols-2">
          {categories.map((category) => (
            <div
              key={category.id}
              className="rounded-2xl border border-stone-200 bg-white p-6 shadow-soft-md"
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-stone-500">No budget set</p>
                  </div>
                </div>
              ...
              <p className="mt-2 text-xs text-stone-400">
                Set a budget to see remaining balance.
              </p>
            </div>
          ))}
        </div>
        ...
        <div className="rounded-xl border border-stone-200 bg-white p-10 text-center shadow-soft-md">
          <p className="text-stone-600">No budgets yet.</p>
        </div>
      )}
    </main>
  )
